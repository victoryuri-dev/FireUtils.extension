...
# Logo única do cabeçalho. WPF (BitmapImage) não decodifica .svg
# nativamente — por isso o arquivo aqui precisa ser raster (.png/.jpg); se
# não existir, mantém-se o placeholder "LOGO" já definido no XAML.
...
def _localizar_logo():
    return _carregar_bitmap(LOGO_PATH)
